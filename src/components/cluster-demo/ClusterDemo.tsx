			...
			<section>
				...
				<div className="mb-8">
					...
					<div className="cluster-1 rounded bg-white p-4 shadow-md dark:bg-gray-800">
						<button className="rounded px-3 py-1 hover:bg-gray-100 dark:hover:bg-gray-700">
							Previous
						</button>
				...
				<div className="mb-8">
					...
					<article className="max-w-sm rounded bg-white p-4 shadow-md dark:bg-gray-800">
						...
						<div className="cluster-3">
							<button className="flex items-center gap-1 rounded border px-3 py-1 text-sm hover:bg-gray-100 dark:hover:bg-gray-700">
								❤️ Like
							</button>
							<button className="flex items-center gap-1 rounded border px-3 py-1 text-sm hover:bg-gray-100 dark:hover:bg-gray-700">
								📤 Share
				...
				<div className="mb-8">
					...
					<div className="cluster-2 rounded bg-white p-4 shadow-md dark:bg-gray-800">
						...
						<span className="text-gray-400">|</span>
						<button className="rounded px-2 py-1 hover:bg-gray-100 dark:hover:bg-gray-700">
							Link
						</button>
						<button className="rounded px-2 py-1 hover:bg-gray-100 dark:hover:bg-gray-700">
							Image
				...
				<div className="mb-8">
					...
					<div className="cluster-2 rounded bg-gray-50 p-4 dark:bg-gray-900">
						...
						<button className="rounded-full border border-gray-300 px-4 py-2 text-sm hover:bg-gray-100 dark:hover:bg-gray-800">
							Electronics
						</button>
						<button className="rounded-full border border-gray-300 px-4 py-2 text-sm hover:bg-gray-100 dark:hover:bg-gray-800">
							Clothing
				...
				<div className="mb-8">
					...
					<div className="space-y-4">
						<div className="rounded bg-gray-50 p-4 dark:bg-gray-900">
							<h5 className="mb-2 font-semibold">Right-aligned (justify-end)</h5>
				...
				<div className="mb-8">
					...
					<header className="rounded bg-white p-4 shadow-md dark:bg-gray-800">
						<div className="cluster-6 justify-between">
							...
							<div className="cluster-4">
								<button className="rounded border px-3 py-1">Sign In</button>
								<button className="rounded bg-blue-500 px-3 py-1 text-white">
									Sign Up
								</button>
							</div>
				...
				<div className="mb-8">
					...
					<div className="cluster-2 md:cluster-4 lg:cluster-6 rounded bg-gradient-to-br from-blue-50 to-purple-50 p-4 dark:from-blue-900 dark:to-purple-900">
						<button className="rounded bg-white px-3 py-1 shadow dark:bg-gray-800">
							Button 1
						</button>
						<button className="rounded bg-white px-3 py-1 shadow dark:bg-gray-800">
							Button 2
